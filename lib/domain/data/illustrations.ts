 ...
 * creates the missing component and rewrites the barrel. Since W2-T4c every
 * entry is a finished drawing (`status: "final"`); a new entry starts as a
 * placeholder until someone draws it.
 *
