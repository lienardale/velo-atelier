/**
 * `/[locale]/dev/bike3d` — test page for the 3D viewer (§3.5, §3.6 AC7).
 *
...
import { DevBike3dHarness } from "./DevBike3dHarness";
import { testPagesEnabled } from "./gate";
...
export default async function DevBike3dPage({
  ...
  return (
    <ClientMessages
      locale={locale}
      namespaces={CLIENT_NAMESPACES["app/[locale]/dev/bike3d/page.tsx"]}
    >
