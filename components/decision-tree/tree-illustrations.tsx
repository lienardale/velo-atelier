 ...
 * the client, shapes from `/api/tree-drawings`. What travels in the page's RSC
 * payload is therefore an element of about 150 bytes instead of the 1–5 kB of
 * geometry it used to be, 54 times over (`.debug/005`).
 *
 ...
 *
 * **What travels, since `.debug/005`.** A finished drawing is handed over as a
 ...
 * from `/api/tree-drawings`, because a payload carrying every drawing the tree
