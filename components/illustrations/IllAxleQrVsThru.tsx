...
/**
 * `axle-qr-vs-thru` — guide illustration placeholder (W1-T4): the frame, rough shapes
 * and the 2 numbered callouts `illustrations.axle-qr-vs-thru.callouts.*` describe.
 *
...
export function IllAxleQrVsThru(props: IllustrationProps) {
  return (
    <GuideIllustrationFrame id="axle-qr-vs-thru" {...props}>
      <circle cx={90} cy={120} r={40} />
      <circle cx={230} cy={120} r={40} />
